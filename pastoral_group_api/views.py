...
from .serializers import FindPastoralGroupSerializer, ListPastoralGroupSerializer, SavePastoralGroupSerializer, UpdatePastoralGroupSerializer
...
class PastoralGroupRepository:
    def get_pastoral_group(self, pk: int):
        try:
            return PastoralGroup.objects.get(id=pk)
        except PastoralGroup.DoesNotExist:
            return None


class SavePastoralGroupView(generics.CreateAPIView):
    #queryset = m.PastoralGroup.objects.all()
    error_message = ErrorMessage
    serializer_class = SavePastoralGroupSerializer
    permission_classes = [permissions.AllowAny]
    
    def post(self, request):
        OBJECTO = 'Grupo da Pastoral'
        try:
...
class ListPastoralGroupView(generics.ListAPIView):
    queryset = PastoralGroup.objects.all()
    serializer_class = ListPastoralGroupSerializer
    permission_classes = [permissions.AllowAny]
    error_message = ErrorMessage
    
    def get(self, request, *args, **kwargs):
        OBJECTO = 'Grupos da Pastoral'
        try:
...
class FindPastoralGroupView(generics.ListAPIView):
    queryset = PastoralGroup.objects.all()
    serializer_class = FindPastoralGroupSerializer
    permission_classes = [permissions.AllowAny]
    error_message = ErrorMessage
    repository = PastoralGroupRepository()
    
    def get(self, request, id: int, **kwargs):
        OBJECTO = 'Grupo da Pastoral'
        
        try:
            pastoral_group = self.repository.get_pastoral_group(id)
            
            if not pastoral_group:
            ...
            serializer = self.serializer_class(pastoral_group)
...
class UpdatePastoralGroupView(generics.UpdateAPIView):
    error_message = ErrorMessage
    #queryset = PastoralGroup.objects.all()
    serializer_class = UpdatePastoralGroupSerializer
    permission_classes = [permissions.AllowAny]
    repository = PastoralGroupRepository()
    ...
    def update(self, request, id: int, **kwargs):
        ...
        try:
            ...
            serializer = self.serializer_class(pastoral_group, data=request.data, partial = True)
...
class DeletePastoralGroupView(generics.DestroyAPIView):
    #queryset = PastoralGroup.objects.all()
    serializer_class = ListPastoralGroupSerializer
    permission_classes = [permissions.AllowAny]
    error_message = ErrorMessage
