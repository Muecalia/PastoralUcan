...
from .views import DeletePastoralActivityView, FindPastoralActivityView, ListPastoralActivityView, SavePastoralActivityView, UpdatePastoralActivityView, UpdatePastoralActivityStatusView
...
urlpatterns = [
    ...
    path('update_pastoral_activity_status/<int:id>', UpdatePastoralActivityStatusView.as_view(), name='update_pastoral_activity_status'),
]
